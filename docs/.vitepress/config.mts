                ...
                sidebar: [
                    ...
                    },
                    {
                        ...
                        items: [
                            ...
                            { text: '边框', link: '/zh/table/border' },
                            { text: '内容缩放', link: '/zh/table/zoom' },
                            { text: '主题', link: '/zh/table/theme' },
                            { text: '多语言', link: '/zh/table/lang' },
                            ...
                            { text: '行拖拽', link: '/zh/table/row-drag' },
                ...
                sidebar: [
                    ...
                    },
                    {
                        ...
                        items: [
                            ...
                            { text: 'Border', link: '/en/table/border' },
                            { text: 'Content Zoom', link: '/en/table/zoom' },
                            { text: 'Theme', link: '/en/table/theme' },
                            { text: 'Locale', link: '/en/table/lang' },
